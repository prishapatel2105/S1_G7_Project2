...
#include "../Amusement_Park_Ticket_System/eligibility_selection.h"
     ...
     *
     * Do not add eligibility_selection.c separately to UnitTest2.
     */
...
namespace UnitTest2
{
    ...
    public:
        ...
        /*
         * Test 1:
         * A valid user and ride should return eligible.
         */
        ...
        /*
         * Test 2:
         * A user below the minimum age should fail.
         */
        ...
        /*
         * Test 3:
         * A user below the minimum height should fail.
         */
        ...
        /*
         * Test 4:
         * A user above the maximum weight should fail.
         */
        ...
        /*
         * Test 5:
         * An existing ride should be detected as a duplicate.
         */
        ...
        /*
         * Test 6:
         * A ride not in the cart should not be a duplicate.
         */
        ...
        /*
         * Test 7:
         * Adding an eligible ride should increase the cart count.
         */
        ...
        /*
         * Test 10:
         * Displaying an empty cart should not crash.
         */
